  ...
  const events = [
    {
      ...
      extendedProps: {
        ...
        imageUrl: 'https://res.cloudinary.com/dgtk4rthy/image/upload/c_crop,g_auto,h_200,w_200/Dental/uifaul8xygqr1ml0ba6d.jpg',
      ...
      {selectedEvent && (
        <div className="event-popup">
          <div className="popup-content">
            ...
            <p><strong>Doctor:</strong> {selectedEvent.extendedProps.doctor}</p>
            <p><strong>Description:</strong> {selectedEvent.extendedProps.description}</p>
            <p><strong>Contact:</strong> {selectedEvent.extendedProps.contact}</p>
